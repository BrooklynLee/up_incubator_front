...
export const Fav: React.FC<IFavProps> = ({
    id,
}) => {
    ...
    return (
        ...
        <div className="bg-white p-3 shadow-sm rounded-sm">
            <div className="flex justify-end space-x-2 font-semibold text-gray-900 leading-8">
                ...
                <button className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded" onClick={() => dispatch(toggleFav(id))}>
                    이 UP를 사용합니다
                </button>
